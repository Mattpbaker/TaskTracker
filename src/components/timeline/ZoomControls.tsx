  ...
  return (
    <div className="flex items-center gap-2 ml-auto">
      <button
        ...
        className="w-6 h-6 flex items-center justify-center bg-surface border border-border rounded text-secondary hover:border-cat-social hover:text-cat-social text-sm"
      >−</button>
      <input
      ...
      <button
        ...
        className="w-6 h-6 flex items-center justify-center bg-surface border border-border rounded text-secondary hover:border-cat-social hover:text-cat-social text-sm"
      >+</button>
      <span className="text-[11px] text-muted w-9 text-center">{zoom}%</span>
    </div>
  )
}
